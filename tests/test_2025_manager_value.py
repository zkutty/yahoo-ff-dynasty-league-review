"""Test 2025 manager draft and trade value using weekly cumulative scoring.

This test analyzes whether players drafted and traded for in 2025 were good value
...
class Test2025ManagerValue:
    """Test suite for 2025 manager draft and trade value analysis."""

    @pytest.fixture
    def season_data(self):
        """Load 2025 season data."""
        data_path = Path(config.DATA_DIR) / "league_data" / "season_2025.json"
